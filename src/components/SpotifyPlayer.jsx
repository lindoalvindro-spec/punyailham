      ...
      {!expanded && (
        ...
        >
          ...
          <div style={{
            ...
            <img
              src="/Justin-Timberlake-The-20-20-Experience-2-of-2-Album-image.webp"
              alt="Mirrors"
              style={{ width: '100%', height: '100%', objectFit: 'cover' }}
              onError={(e) => { e.target.src = '/Justin-Timberlake-The-20-20-Experience-2-of-2-Album-image.webp'; }}
            />
            {playing && (
